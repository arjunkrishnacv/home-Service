...
const Bathroom = () => {
  ...
  const serviceOptions = [
    { value: 'Basic Cleaning', label: 'Basic Cleaning (Bathroom)', rate: 1500 },
    { value: 'Deep Cleaning', label: 'Deep Cleaning (Bathroom)', rate: 2500 },
    { value: 'Sanitization', label: 'Sanitization (Bathroom)', rate: 2000 },
  ];
  ...
  const [orderDetails, setOrderDetails] = useState({
    ...
    rate: 1500, // Default rate for Basic Cleaning
  });
  ...
  const handleChange = (selectedOption) => {
    setOrderDetails(prev => ({
      ...
      rate: selectedOption?.rate || 1500, // Update rate if a service is selected
    }));
  };
      ...
      <div className="container vh-50">
        <div className="row">
                ...
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    <ol>
                      ...
                      <li>
                        <strong>Service Scope</strong> - Our bathroom cleaning services include basic cleaning, deep cleaning, and sanitization.
                      </li>
                      <li>
                        <strong>Customer Responsibilities</strong> - Ensure access to the premises and secure any valuables before the service begins.
                      </li>
                      <li>
                        <strong>Liability</strong> - We are not responsible for pre-existing damage to bathroom fixtures.
                      </li>
                      <li>
          ...
          <div className="col-lg-6">
            <img width={'80%'} className="mt-5 ms-5 shadow rounded-3" src={bath} alt="" />
          </div>
          <div className="mt-5">
            <h3 className="fw-bold">How it Works</h3>
            <p>Our bathroom cleaning services are designed to provide a deep, thorough clean for your bathroom:</p>
            <p>
              Whether it’s a quick basic cleaning, a thorough deep clean, or complete sanitization, we’ve got you covered. Select your service, choose a time that fits your schedule, and our team of professional cleaners will arrive on time to give your bathroom a sparkling finish.
            </p>
          </div>
        </div>
      </div>

...
import tvservice from '../assets/tvservice.jpg'
   ...
   <div className='container'>
       <div className='row'>
            <div className='col-lg-6 mt-5'>
                <h1 className='fw-bold'>"Screen Issues? We’ve Got the Perfect Fix!"</h1>
            ...
            <div className='col-lg-6'>
                <img width={'80%'} className='mt-5 ms-5 shadow rounded-3' src={tvservice} alt="" />
            </div>

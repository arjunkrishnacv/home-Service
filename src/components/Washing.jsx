...
const Washing= () => {
    ...
    const handleShow = () => setShow(true);
        ...
        const serviceOptions = [
          { value: 'Washing Machine', label: 'Washine Machine repair' },
        ];
   ...
   <div className='container'>
       <div className='row'>
            <div className='col-lg-6 mt-5'>
                <h1 className='fw-bold'>"Expert Care to Extend Your Washing Machine’s Life!"</h1>
            ...
            <div className='col-lg-6'>
                <img width={'80%'} className='mt-5 ms-5 shadow rounded-3' src={wash} alt="" />
            </div>
